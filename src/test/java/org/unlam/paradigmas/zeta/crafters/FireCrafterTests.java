...
class FireCrafterTests {
	private FireCrafter crafter;
    ...
    @BeforeEach
    void setUp() {
        crafter = new FireCrafter();

        // Ingredientes
        ingrediente1 = new Element("C8", Classification.FIRE);
        ingrediente2 = new Element("H18", Classification.FIRE);
        catalizador = crafter.catalyst();

        // Producto final
        elementoFinal = new Element("MezclaFuego", Classification.FIRE);
    ...
    @Test
    void testTypeDevuelveFIRE() {
        assertEquals(Classification.FIRE, crafter.type());
    }
